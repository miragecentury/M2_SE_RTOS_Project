...
#ifndef TM4C129X_ETH_TX_BUFFER_COUNT
   #define TM4C129X_ETH_TX_BUFFER_COUNT 3
#elif (TM4C129X_ETH_TX_BUFFER_COUNT < 1)
   #error TM4C129X_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef TM4C129X_ETH_TX_BUFFER_SIZE
   #define TM4C129X_ETH_TX_BUFFER_SIZE 1536
#elif (TM4C129X_ETH_TX_BUFFER_SIZE != 1536)
   #error TM4C129X_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef TM4C129X_ETH_RX_BUFFER_COUNT
   #define TM4C129X_ETH_RX_BUFFER_COUNT 6
#elif (TM4C129X_ETH_RX_BUFFER_COUNT < 1)
   #error TM4C129X_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef TM4C129X_ETH_RX_BUFFER_SIZE
   #define TM4C129X_ETH_RX_BUFFER_SIZE 1536
#elif (TM4C129X_ETH_RX_BUFFER_SIZE != 1536)
   #error TM4C129X_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef TM4C129X_ETH_IRQ_PRIORITY_GROUPING
   #define TM4C129X_ETH_IRQ_PRIORITY_GROUPING 3
#elif (TM4C129X_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error TM4C129X_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef TM4C129X_ETH_IRQ_PRIORITY
   #define TM4C129X_ETH_IRQ_PRIORITY 192
#elif (TM4C129X_ETH_IRQ_PRIORITY < 0)
   #error TM4C129X_ETH_IRQ_PRIORITY parameter is not valid
#endif
...
void tm4c129xEthEventHandler(NetInterface *interface);
...
error_t tm4c129xEthReceivePacket(NetInterface *interface,
